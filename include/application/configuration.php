...
DEFINE('_CONFIG_PATH','/custom/website/avenue-mandarine/httpdocs/ressources/');
...
DEFINE('_CONFIG_DATABASE','avm');
DEFINE('_CONFIG_USER','avm');
DEFINE('_CONFIG_PASSWORD','Z(BVek');
